...
export default function InboxScreenAndroid(
  _props: AppInboxStackScreenProps<'Inbox'>,
) {
  ...
  const handleAddTask = () => {
    if (!hasShareIntentContent(shareIntent) || !selectedCollectionId) {
      return;
    }
    ...
    createTask(
      {
        data: {
          title: getShareIntentTaskTitle(shareIntent),
